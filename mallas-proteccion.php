<?php
/*
Template Name: Mallas proteccion
*/
?>
...
<div class="container">
	...
	<div class="titulo-interior"><h2>Mallas de protección</h2></div>
		<div id="custom_carousel" class="carousel slide" data-ride="carousel" data-interval="15000">
            ...
            <?php 
		        ...
		        $args = array(
		        	...
		        	'tax_query' => array(
						                  	array(
							                    'taxonomy' => 'categoria',//nombre de la taxonomy
							                    'field'    => 'slug',
							                    'terms' => 'proteccion'//slug
						                  	)
							            ) 
			    ); 
    ...
    <div class="formulario wow fadeIn">
    	...
    	<form id="contact-form" name="contact-form" action="<?php bloginfo('url'); ?>/mallas-de-proteccion/#contact-form" method="post">
		 				...
		 				if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){
                          ...
                          if($responseData->success){
                              ...
                              if (count($reg_errors->get_error_messages()) == 0) {
                                ...
                                //Asunto del email
                                $subject = 'Formulario de contacto para mallas de protección ' . get_bloginfo( 'name' );
