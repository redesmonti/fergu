<?php
/*
Template Name: servicio cortinas madera
*/
?>
...
<div class="container">
	...
	<div class="titulo-interior"><h2>Servicio a cortinas de madera</h2></div>
		                ...
		                if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){
                          ...
                          if($responseData->success){
                              ...
                              if (count($reg_errors->get_error_messages()) == 0) {
                                ...
                                //Asunto del email
                                $subject = 'Formulario de contacto para servicio a cortinas de madera ' . get_bloginfo( 'name' );
