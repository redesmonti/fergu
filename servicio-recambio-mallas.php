...
<div class="container">
    ...
    <div class="formulario wow fadeIn">
    	...
    	<form id="contact-form" name="contact-form" action="<?php bloginfo('url'); ?>/recambio-mallas-proteccion/#contact-form" method="post">
		 				...
		 				if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){
                          ...
                          if($responseData->success){
                              ...
                              if (count($reg_errors->get_error_messages()) == 0) {
                                ...
                                //Asunto del email
                                $subject = 'Formulario de contacto para servicio a recambio de mallas ' . get_bloginfo( 'name' );
